...
const inks = [
  { name: 'ink', hex: '#f4e8ff', cls: 'text-ink', divider: false },
  { name: 'ink-soft', hex: '#d9c8e8', cls: 'text-ink-soft', divider: false },
  { name: 'mute', hex: '#8a6b99', cls: 'text-mute', divider: false },
  { name: 'rule', hex: '#3d1f4d', cls: 'text-rule', divider: true },
]
