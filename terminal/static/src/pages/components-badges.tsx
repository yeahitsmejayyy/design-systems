    ...
    <PreviewFrame title="components / badges">
      <div className="p-7 flex flex-col gap-4">
        <div className="flex gap-[10px] items-center flex-wrap">
          ...
          <Badge variant="bright">● active</Badge>
          <Badge variant="warn">● pending</Badge>
          <Badge variant="soft">● error</Badge>
        ...
        <div className="flex gap-[10px] items-center flex-wrap">
          ...
          <Badge variant="mid">tool</Badge>
          <Badge variant="soft">shipped</Badge>
        </div>
        ...
        <div className="flex gap-[10px] items-center flex-wrap">
          ...
          <Kicker tone="bright">// 01 · thesis</Kicker>
          <Kicker tone="mid">// 02 · agents</Kicker>
        </div>
      </div>
    </PreviewFrame>
  )
