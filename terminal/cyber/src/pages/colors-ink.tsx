...
const inks = [
  { name: 'ink', hex: '#e6f2ff', cls: 'text-ink', divider: false },
  { name: 'ink-soft', hex: '#9fc0e6', cls: 'text-ink-soft', divider: false },
  { name: 'mute', hex: '#4d6a8a', cls: 'text-mute', divider: false },
  { name: 'rule', hex: '#1c3050', cls: 'text-rule', divider: true },
]
