...
const rows: { tag: string; buttons: { variant: 'primary' | 'secondary' | 'ghost' | 'hot' | 'terminal'; label: string }[] }[] = [
  {
    tag: 'primary',
    buttons: [
      { variant: 'primary', label: 'Connect' },
      { variant: 'primary', label: '→ Jack in' },
    ],
  },
  {
    tag: 'secondary',
    buttons: [
      { variant: 'secondary', label: 'Trace' },
      { variant: 'secondary', label: 'Decrypt' },
    ],
  },
  {
    tag: 'ghost',
  ...
  {
    tag: 'hot · rare',
    buttons: [{ variant: 'hot', label: 'Drop session' }],
  },
  {
    tag: 'terminal',
